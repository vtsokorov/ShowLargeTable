...
public class DefaultDataSourceService<DAOService extends DAOInterface<?>> implements DistributedTableDataSource 
{
	 ...
	 */
	public DefaultDataSourceService(DAOService service) throws Exception {
		super();
	...
	@Override
	public DAOInterface<?> getDAOService() {
		return service;
	}
}
